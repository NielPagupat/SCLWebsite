  ...
  return (
    <div id="about-us">
      <div className="flex">
        ...
        <div className="flex-1 p-5 border border-amber-400 bg-gradient-to-b from-emerald-700 to-lime-400 m-5 ml-0 rounded-lg shadow-xl">
      ...
      <div className="flex flex-col-reverse m-5 text-Font items-center">
        <div className="flex flex-col flex-1 justify-center items-center  p-3 bg-gradient-to-b from-emerald-700 to-lime-400 w-4/5 rounded-xl shadow-xl">
        ...
        <div className="flex flex-1 pb-10 justify-around">
          ...
          <div className="flex flex-col w-2/5 p-5 items-center bg-gradient-to-b from-emerald-700 to-lime-400 rounded-xl shadow-xl">
            <div className="flex justify-center items-center gap-1">
      ...
      <div className="flex flex-col items-center mt-10 pt-5 pb-5 bg-gradient-to-b from-emerald-700 to-lime-400 border border-amber-400 m-5 rounded-xl shadow-xl text-Font font-tomorrow">
