...
export default function ProductPortfolio() {
    ...
    return (
        <div className="flex flex-col m-5 mt-10 mr-0 rounded-xl shadow-xl items-end bg-PaperBlack" id="products-portfolio">
            ...
            <div    
                ref={scrollRef}
                className="flex  border border-black bg-PaperBlack shadow-xl m-5 ml-16 mr-0 rounded-tl-3xl p-5 w-11/12 overflow-x-scroll"
            ...
            >
                ...
                <button className="mr-5 h-24 size-16 self-center" onClick={goToProdAll}>
