...
export default function ProductList() {
  ...
  return (
    <div className='grid grid-cols-3 mt-5 mx-10 rounded-lg' >
            {
                items.map((Prod, e)=> 
                <div className='flex flex-col items-center p-5 m-5 border border-black rounded-lg shadow-lg bg-gradient-to-b from-emerald-800 to-lime-400 hover:scale-110 hover:shadow-2xl transition duration-150 ease-in-out'
                     key={e} >
